...
<?php endif; ?>
            ...
            <ul class="site-nav site-navbar">
                <li><a href="<?php $this->options ->siteUrl(); ?>"><i class="fa fa-home"></i> 网站首页</a></li>
                
<?php if ($this->options->categorymenu == 'able'): ?>
                <li>
                    <a><i class="fa fa-folder-open"></i> 网站源码</a>
                    <ul class="sub-menu">
...
<?php if ($this->options->pagemenu == 'able'): ?>                   
                <li>
                    <a><i class="fa fa-file-text-o"></i>关于我们</a>
                    <ul class="sub-menu">
    ...
    <div class="site-search">
        <div class="container">
            <form method="post" class="site-search-form" action="<?php $this->options ->siteUrl(); ?>">
                <input class="search-input" name="s" type="text" placeholder="请输入关键字" value="">
