...
?>
               <div class="comt-avatar"><?php $a = 'http://q.qlogo.cn/headimg_dl?bs=qq&dst_uin=' . strtolower($comments->mail) . '&src_uin=qq&fid=blog&spec=100';?><img class="avatar photo" src="<?php echo $a ?>" alt="<?php echo $comments->author; ?>" height="50" width="50" /></div>
...
<?php if($this->user->hasLogin()): ?>
                   ...
                   <?php elseif($this->remember('author',true) != "" && $this->remember('mail',true) != ""): ?><?php $this->remember('author'); ?><?php endif; ?>
                    ...
                    <textarea placeholder="欢迎在此评论，发表你的意见吧～" class="input-block-level comt-area" name="text" id="comment" cols="100%" rows="3" tabindex="1" ></textarea>
